...
<head>
    ...
    <!-- Fonts & Icons -->
    <link href="https://fonts.googleapis.com/css2?fammily=Inter:wght@400;500;600&family=Poppins:wght@600;700&display=swap" rel="stylesheet">
...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Cool rainy    Collection — Premium Picks</h1>
